...
In addition there exists the sensible default for Kot# Aurora Gradle Plugin
...
In addition there exists the sensible default for SpringBoot applications. It is enabled like this:
...
* Add `id("no.skatteetaten.gradle.aurora") version("local-SNAPSHOT")` to your `build.gradle.kts` filelin applications. It is enabled like this:
